...
public class Measures {
	...
	public static List<EvalObj> measure(final List<Answer> rankedAnswer, final HAWKQuestion q, final int maxK) {
		...
		// omment=Measure @1, fmax=0.8, precision=0.6666666666666666, recall=1.0,
		// question=Which recipients of the Victoria Cross died in the Battle of
		// Arnhem?, id=305]
		// EvalObj [comment=Measure @2, fmax=0.0, precision=0.0, recall=0.0,
		// question=Which recipients of the Victoria Cross died in the Battle of
		// Arnhem?, id=305]
		// EvalObj [comment=Measure @3, fmax=0.0, precision=0.0, recall=0.0,
		// question=Which recipients of the Victoria Cross died in the Battle of
		// Arnhem?, id=305]
		// EvalObj [comment=Measure @4, fmax=0.0, precision=0.0, recall=0.0,
		// question=Which recipients of the Victoria Cross died in the Battle of
		// Arnhem?, id=305]
		// EvalObj [comment=Measure @5, fmax=0.0, precision=0.0, recall=0.0,
		// question=Which recipients of the Victoria Cross died in the Battle of
		// Arnhem?, id=305]
		// EvalObj [comment=Measure @6, fmax=0.5, precision=0.5, recall=0.5,
		// question=Which recipients of the Victoria Cross died in the Battle of
		// Arnhem?, id=305]
		// EvalObj [comment=Measure @7, fmax=0.0, precision=0.0, recall=0.0,
		// question=Which recipients of the Victoria Cross died in the Battle of
		// Arnhem?, id=305]
		// EvalObj [comment=Measure @8, fmax=0.28571428571428575, precision=0.2,
		// recall=0.5, question=Which recipients of the Victoria Cross died in the
		// Battle of Arnhem?, id=305]
		// EvalObj [comment=Measure @9, fmax=0.0, precision=0.0, recall=0.0,
		// question=Which recipients of the Victoria Cross died in the Battle of
		// Arnhem?, id=305]
		// EvalObj [comment=Measure @10, fmax=0.3636363636363636,
		// precision=0.2222222222222222, recall=1.0, question=Which recipie
